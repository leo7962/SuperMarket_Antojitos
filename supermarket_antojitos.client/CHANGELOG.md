...
- Create Angular project with ng: `ng new supermarket_antojitos.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`supermarket_antojitos.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `supermarket_antojitos.client.esproj`).
